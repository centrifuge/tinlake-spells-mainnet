...
contract TinlakeSpell {
    ...
    function execute() internal {
        ...
        MemberlistLike(address(SENIOR_MEMBERLIST_BL1)).rely(MEMBERADMIN);
        MemberlistLike(address(JUNIOR_MEMBERLIST_BL1)).rely(MEMBERADMIN);
        MemberlistLike(address(SENIOR_MEMBERLIST_CF4)).rely(MEMBERADMIN);
        MemberlistLike(address(JUNIOR_MEMBERLIST_CF4)).rely(MEMBERADMIN);
        MemberlistLike(address(SENIOR_MEMBERLIST_DBF1)).rely(MEMBERADMIN);
        MemberlistLike(address(JUNIOR_MEMBERLIST_DBF1)).rely(MEMBERADMIN);
        MemberlistLike(address(SENIOR_MEMBERLIST_FF1)).rely(MEMBERADMIN);
        MemberlistLike(address(JUNIOR_MEMBERLIST_FF1)).rely(MEMBERADMIN);
        MemberlistLike(address(SENIOR_MEMBERLIST_HTC2)).rely(MEMBERADMIN);
        MemberlistLike(address(JUNIOR_MEMBERLIST_HTC2)).rely(MEMBERADMIN);
        MemberlistLike(address(SENIOR_MEMBERLIST_NS2)).rely(MEMBERADMIN);
        MemberlistLike(address(JUNIOR_MEMBERLIST_NS2)).rely(MEMBERADMIN);
        MemberlistLike(address(SENIOR_MEMBERLIST_PC3)).rely(MEMBERADMIN);
        MemberlistLike(address(JUNIOR_MEMBERLIST_PC3)).rely(MEMBERADMIN);

        // TODO: Make onboard API an admin on the member admin
